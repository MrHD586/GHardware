<?php
	...
	class ArticleManager {
		...
		public function getArticleByIdAndImage($idarticle) {
		    $sql = "SELECT * FROM t_article INNER JOIN t_imagearticle ON t_article.Fk_ImageArticle = t_imagearticle.idImageArticle WHERE idArticle='".intval($idarticle)."' AND t_imageuser.isActive = 1"; 
