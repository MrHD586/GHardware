<?php
    ...
    if($_GET['inactive']){
        $linkForDisplayedList = '<a style="margin-left:590px;"href="index.php?controller=Admin&action=category">Affichage des actifs</a>';
    }else{
        $linkForDisplayedList = '<a style="margin-left:580px;"href="index.php?controller=Admin&action=category&inactive=TRUE">Affichage des inactifs</a>';
    }
